...
function Home() {
  ...
  const uniqueSources = articles.reduce(
    (sources: string[], article: Article) => {
  ...
  const filteredArticles = source
    ? articles.filter((article: Article) => article.source.name === source)
    : articles;
                    ...
                    <Grid container alignItems="center">
                      <Grid item xs={6}>
                        <Typography variant="body1">
                          Showing {startIndex} to {endIndex} of {totalResults}{" "}
                          articles.
                        </Typography>
                      </Grid>
                      <Grid item xs={6}>
