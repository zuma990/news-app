...
export default function SearchPage() {
    ...
    const [sortBy, setSortBy] = useState<'popularity' | 'relevancy' | 'publishedAt'>('popularity');
    const dispatch = useDispatch<AppDispatch>();
    const handleSortByChange = (event: SelectChangeEvent<'popularity' | 'relevancy' | 'publishedAt'>) => {
